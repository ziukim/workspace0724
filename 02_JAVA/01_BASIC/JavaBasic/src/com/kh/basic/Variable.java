...
public class Variable {
	...
	public static void main(String[] args) {
		...
		char ch2 = '지';
		char ch3 = '원';
		//System.out.println(ch1 + ch2 + ch3); 이렇게 작성 시 결과값이 숫자로 나옴
		System.out.println("" + ch1 + ch2 + ch3);
		System.out.println(ch1); //하나만 쓴 경우는 문자형으로 잘 나오지만
		System.out.println((int)ch1); // 문자형 사이에 +같은 연산자가 들어가면 int 형 으로 변환됨.
									  // 기본적으로 char은 연산시 int로 형변환이 일어난다.
		...
		/*
		 * 이스케이프 시퀀스
		 * 문자열내에서 탭, 백슬러스, 작따옴표등을 사용하기위한 방식
		 */
...
//		MY_AGE = 111;  --값을 한번 초기화하면 더이상 변경할 수 없음.
		...
		/*
		 * 프로그래밍에서 이름 짓는 방식
		 * 카멜케이스 : 단어를 나열하며 이름을 짓되, 두번째 단어부터는 단어의 첫 글자를 대문자로 시작
		 ...
		 * 
		 * 대문자스네이크케이스 : 스네이크케이스 + 모두대문자 (대부분 언어에서 상수명)
		 * ex) USER_NAME
		 * 
